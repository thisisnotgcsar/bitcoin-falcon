...
public:
    ...
    virtual bool CheckFalconSignature(const std::vector<unsigned char>& sig, const std::vector<unsigned char>& pubkey,  const CScript& scriptCode, SigVersion sigversion) const
    {
        return false;
    }
...
protected:
    ...
    virtual bool VerifyFalconSignature(const std::vector<unsigned char>& vchSig, const std::vector<unsigned char>& vchPubKey, const uint256& sighash) const;
...
public:
    ...
    bool CheckFalconSignature(const std::vector<unsigned char>& vchSigIn, const std::vector<unsigned char>& vchPubKey,const CScript& scriptCode, SigVersion sigversion) const override;
